...
def train_epoch(
    ...
    # print('loss fun is ') # Oli
    # print(loss_fun) # Oli

    for cur_iter, (inputs, labels, index, time, meta) in enumerate(train_loader):
        # print('size of inputs=',len(inputs)) # Oli
        # print('size of inputs[0]=',len(inputs[0])) # Oli
        # print('size of inputs[0][0]=',len(inputs[0][0])) # Oli
        # print('size of inputs[0][0][0]=',len(inputs[0][0][0])) # Oli
        # print('size of inputs[0][0][0][0]=',len(inputs[0][0][0][0])) # Oli
        # print('size of inputs[0][0][0][0][0]=',len(inputs[0][0][0][0][0])) # Oli
        ...
        with torch.cuda.amp.autocast(enabled=cfg.TRAIN.MIXED_PRECISION):
            ...
            if cfg.MODEL.MODEL_NAME == "ContrastiveModel" and partial_loss:
                ...
                # Compute the loss.
                # print('preds is', preds) # Oli 
                # print('labels is',labels) # Oli
...
def eval_epoch(val_loader, model, val_meter, cur_epoch, cfg, train_loader, writer):
    ...
    # print('train_net.py val preds=',preds)# Oli
    # print('train_net.py val labels=',labels)# Oli
    # print('train_net.py val_meter.all_preds=',torch.cat(val_meter.all_preds, dim=0)) # Oli
    # print('train_net.py val_meter.class_whitelist',val_meter.class_whitelist) # Oli
    # Log epoch stats.
