...
def get_ava_eval_data(
    ...
    count = 0
    # print('ava_eval_helper.py get_ava_eval_data class_whitelist=',class_whitelist) # Oli
    # print('ava_eval_helper.py get_ava_eval_data scores.shape[0]=',scores.shape[0]) # Oli
    for i in range(scores.shape[0]):
        video_idx = int(np.round(metadata[i][0]))
        # print('ava_eval_helper.py video_idx=',video_idx) # Oli
        sec = int(np.round(metadata[i][1]))

        video = video_idx_to_name[video_idx]
        # print('ava_eval_helper.py video=',video) # Oli
        ...
        # print('ava_eval_helper.py scores[i]=',scores[i].tolist()) # Oli
        # print('ava_eval_helper.py key=',key) # Oli
    ...
    # print('ava_eval_helper.py get_ava_eval_data out_boxes, out_labels, out_scores=',out_boxes,'|', out_labels,'|', out_scores) # Oli
