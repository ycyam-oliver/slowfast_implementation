...
FPS = 30
AVA_VALID_FRAMES = range(0, 600) # Oli
...
def load_boxes_and_labels(cfg, mode):
    ...
    # print('cfg.AVA.ANNOTATION_DIR=',cfg.AVA.ANNOTATION_DIR)# Oli
    # print('gt_lists[0]=',gt_lists[0]) # Oli
    ann_filenames = [
    ...
    for filename, is_gt_box in zip(ann_filenames, ann_is_gt_box):
        with pathmgr.open(filename, "r") as f:
            for line in f:
                ...
                # print('video_name=',video_name) # Oli
                # print('valid frames=',AVA_VALID_FRAMES) # Oli
                # print(list(all_boxes.keys())) # Oli

                if frame_sec not in all_boxes[video_name]: # Oli
                    all_boxes[video_name][frame_sec]={} # Oli
