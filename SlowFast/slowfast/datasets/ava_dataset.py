...
class Ava(torch.utils.data.Dataset):
    ...
    def _load_data(self, cfg):
        ...
        # print('image_path[0][0]=',self._image_paths[0][0]) # Oli
        # print('len(len(self._image_paths))=',len(self._image_paths)) # Oli
        # print('len(boxes_and_labels)=',len(boxes_and_labels)) # Oli
        # print('boxes_and_labels[0]=',list(boxes_and_labels)[0]) # Oli
        
        # # Oli
        # label_available=set(list(boxes_and_labels))
        # img_paths=[]
        # video_indices=[]
        # for path_i,img_path in enumerate(self._image_paths):
        #     curr_path=img_path[0]
        #     vi_name=curr_path.split('/')[2]
        #     if vi_name in label_available:
        #         img_paths.append(img_path)
        #         video_indices.append(vi_name)
        #     elif vi_name not in label_available:
        #         print('No',vi_name)
        # print('num of self._image_paths',path_i)
        # self._image_paths=img_paths
        # self._video_idx_to_name=video_indices
        # print('NEW len(len(self._image_paths))=',len(self._image_paths)) # Oli
        # # Oli
