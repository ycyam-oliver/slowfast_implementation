...
from slowfast.config.defaults import get_cfg # Oli
from detectron2 import model_zoo # Oli
...
class YOLOPredictor:
    ...
    def __init__(self, cfg, gpu_id=None):
        # 加载预训练的 YOLOv8n 模型
        self.model = YOLO('/home/pigs/YOLO_models/runs/detect/pigs-behaviours2/weights/best.pt')
